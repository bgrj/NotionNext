...
fnTextPopup(['being', '存在', '是个人', '自洽', '羁绊', '偏见', '失去', '觉察', '边界', '悲悯', '苦难', '欲望', '真实', '宽恕', '荒诞', '自由', '信任', '敬畏', '信仰', '责任', '遗忘', '抉择', '沟通', '勇气', '虚无', '妥协', '重塑', '意义', '爱意', '救赎', '孤独', '告别', '死亡','思想', '所信', '共情', '所践', '成长', '所是', '探索', '多元', '包容', '尊重', '人性', '慎独', '无常']);
