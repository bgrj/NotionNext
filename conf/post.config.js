...
module.exports = {
  ...
  POSTS_SHARE_SERVICES:
    ...
    'link,wechat,qq,email,twitter,telegram,reddit,whatsapp', // 分享的服務，按顺序显示,逗号隔开
  ...
  POST_PREVIEW_LINES: process.env.NEXT_PUBLIC_POST_POST_PREVIEW_LINES || 6, // 预览博客行数
  POST_RECOMMEND_COUNT: process.env.NEXT_PUBLIC_POST_RECOMMEND_COUNT || 6, // 推荐文章数量
  POSTS_PER_PAGE: process.env.NEXT_PUBLIC_POST_PER_PAGE || 3, // post counts per page
