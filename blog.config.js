...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '不过人间·EのT', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个终生追求自我解放成为人的无知者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://bgrj.edu.pl', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '不过人间·EのT', // 网站关键词 英文逗号隔开
