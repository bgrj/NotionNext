...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '609ca340a289839ea91b01294f29c02b',
  ...
  SINCE: process.env.NEXT_PUBLIC_SINCE || '2026-2027', // e.g if leave this empty, current year will be used.
...
<<<<<<< HEAD
  REDIS_URL: process.env.REDIS_URL || '', // Redis 连接地址，供服务端缓存与单篇文章访问数据统计使用
=======
  REDIS_URL: process.env.REDIS_URL || 'rediss://default:gQAAAAAAAV_mAAIncDExYjFiMjM5ZTQzOGQ0NGU1YTE4Zjg5ZjQ4M2NlN2QwMnAxOTAwODY@promoted-giraffe-90086.upstash.io:6379', // Redis 连接地址，供服务端缓存与单篇文章访问数据统计使用
>>>>>>> b34b3f685cc9130a4564a82e4ac718aa5837acd1
  ...
  BEI_AN_LINK: process.env.NEXT_PUBLIC_BEI_AN_LINK || '/', // 中国大陆ICP备案查询链接
  BEI_AN_GONGAN: process.env.NEXT_PUBLIC_BEI_AN_GONGAN || '', // 公安网络备案号，例如：'浙公网安备3xxxxxxxx8号'
