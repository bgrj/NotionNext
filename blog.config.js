...
const BLOG = {
  ...
  REDIS_URL: process.env.REDIS_URL || 'redis-cli --tls -u redis://default:gQAAAAAAAV_mAAIncDExYjFiMjM5ZTQzOGQ0NGU1YTE4Zjg5ZjQ4M2NlN2QwMnAxOTAwODY@promoted-giraffe-90086.upstash.io:6379', // Redis 连接地址，供服务端缓存与单篇文章访问数据统计使用
